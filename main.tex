...
\begin{enumerate}
    ...
    \item Xiaodong Zhang: \emph{Models with reduced special fiber};
...
The present book is the result of this development. The original seminar notes were compiled, edited and extended by Maximilian Fülle. The content of the first four talks are the germ of Part I, \emph{Models and valuations}. The notes for the fifth talk will be incorporated into Part II, \emph{Analytic and computation tools}.
...
Stefan Wewers, and Maximilian Fülle}
\label{part:models-and-valuations}

\input{chapters/01-curves-over-valued-fields-and-their-models}
\input{chapters/02-correspondence-between-models-and-valuations}
\input{chapters/03-base-change-reduced-fibers-and-permanence}

\part{Analytic and computational tools}

\input{chapters/04-analytic-and-computational-tools}
