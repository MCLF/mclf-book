...
An unqualified cover of curves is a finite dominant morphism; when separability matters, we write \emph{finite separable cover}.
...
When $L/K$ is finite, ordinary base change is denoted by $\X_{\OL}$ and its normalization in $F_{X_L}$ by
\[
    \X_L.
\]
