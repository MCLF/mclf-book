...
\begin{example}\label{ex:model-of-plane-curve}
    ...
    with $x = X/Z$ and $y = Y/Z$, $\xi$ corresponds to the ideal $\m$ which is generated by a uniformising parameter $\pi \in \OK$
...
\begin{proof}
    ...
    Let $\pi_\xi$ be a uniformising parameter of this ring. There is a unit
